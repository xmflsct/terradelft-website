...
const H3: React.FC<Props> = props => {
  return (
    <h3
      className={`text-xl mb-2 ${props.className}`}
      children={props.children}
    />
  )
}
const H4: React.FC<Props> = props => {
  return (
    <h4
      className={`text-lg mb-1 ${props.className}`}
      children={props.children}
    />
  )
}
const H5: React.FC<Props> = props => {
  return (
    <h5
      className={`text-lg font-bold mb-1 ${props.className}`}
      children={props.children}
    />
  )
}
const H6: React.FC<Props> = props => {
  return (
    <h6
      className={`font-bold mb-1 ${props.className}`}
      children={props.children}
    />
  )
}
